...
void  ofxCvImage::operator = ( const IplImage* mom ) {
        ...
        mom->depth == cvImage->depth )
    {
		...
		cout << "mom->width: " << mom->width <<  " width: "  << width << endl;
		cout << "mom->height: " << mom->height <<  " height: "  << height << endl;
		cout << "mom->nChannels: " << mom->nChannels <<  " cvImage->nChannels: "  << cvImage->nChannels << endl;
		cout << "mom->depth: " << mom->depth <<  " cvImage->depth: "  << cvImage->depth << endl;
